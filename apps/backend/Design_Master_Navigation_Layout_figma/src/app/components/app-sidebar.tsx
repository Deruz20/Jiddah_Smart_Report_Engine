...
const navItems = [
  ...
  { icon: ClipboardEdit, label: "Marks Entry", id: "marks" },
  { icon: Printer, label: "Report Center", id: "reports" },
  ...
  return (
    <SidebarMenuItem>
      <SidebarMenuButton
        ...
        tooltip={label}
        className={cn(
          "group/nav-item relative h-11 rounded-xl transition-all duration-200",
          "text-slate-400 hover:text-white hover:bg-white/10",
          active && "bg-white/15 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]",
        )}
      ...
      >
        ...
        <AnimatePresence>
          {!collapsed && (
            <motion.span
              ...
              className={cn(
                "truncate text-sm",
                active ? "text-white" : "text-slate-400 group-hover/nav-item:text-slate-200",
              )}
            >
              {label}
            </motion.span>
        ...
        {active && (
          <motion.div
            ...
            className="absolute right-2 size-1.5 rounded-full bg-emerald-400 shadow-[0_0_6px_2px_rgba(52,211,153,0.5)]"
          />
        )}
      </SidebarMenuButton>
    </SidebarMenuItem>
