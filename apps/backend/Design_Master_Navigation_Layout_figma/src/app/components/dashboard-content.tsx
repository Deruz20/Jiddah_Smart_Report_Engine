...
const stats = [
  { label: "Total Students", value: "1,284", change: "+12%", up: true, icon: Users, gradient: "from-emerald-500 to-teal-600", bg: "bg-emerald-50", iconColor: "text-emerald-500" },
  { label: "Avg. Score", value: "78.4%", change: "+3.2%", up: true, icon: TrendingUp, gradient: "from-emerald-500 to-teal-600", bg: "bg-emerald-50", iconColor: "text-emerald-500" },
  { label: "Reports", value: "342", change: "+28", up: true, icon: FileText, gradient: "from-orange-500 to-amber-600", bg: "bg-orange-50", iconColor: "text-orange-500" },
  { label: "Top Performers", value: "89", change: "-4", up: false, icon: Award, gradient: "from-rose-500 to-pink-600", bg: "bg-rose-50", iconColor: "text-rose-500" },
];
...
const recentActivity = [
  { name: "Fatimah Al-Zahra", grade: "Grade 7A", score: 94, subject: "Mathematics", time: "2m ago" },
  { name: "Omar Al-Rashid", grade: "Grade 8B", score: 87, subject: "Science", time: "15m ago" },
  { name: "Aisha Mohammed", grade: "Grade 6C", score: 91, subject: "Arabic", time: "32m ago" },
  { name: "Khalid Ibrahim", grade: "Grade 9A", score: 76, subject: "English", time: "1h ago" },
  { name: "Nour Al-Hassan", grade: "Grade 7B", score: 89, subject: "Islamic Studies", time: "2h ago" },
];

const classes = [
  { name: "Grade 6A", students: 34, completion: 92, teacher: "Ms. Sara" },
  { name: "Grade 7B", students: 31, completion: 78, teacher: "Mr. Ahmed" },
  { name: "Grade 8C", students: 28, completion: 85, teacher: "Ms. Layla" },
  { name: "Grade 9A", students: 30, completion: 67, teacher: "Mr. Tariq" },
];

/* ─── Sub-components ──────────────────────────────────────────────────────── */

function StatCard({ label, value, change, up, icon: Icon, gradient, bg, iconColor }: typeof stats[0]) {
  return (
    <motion.div
      whileTap={{ scale: 0.98 }}
      whileHover={{ y: -2 }}
