...
import type { Term, Student, ExamType } from '../pages/MarksEntryPage'
...
export default function SelectionBar({
  terms, students, selectedTerm, selectedStudent, examType,
            ...
            {filtered.length === 0 ? (
              ...
              >
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  <div style={{ color: '#9ca3af', fontSize: 11 }}>{s.admissionNo} · Class {s.class}</div>
                </div>
              </button>
            ))}
          </div>
