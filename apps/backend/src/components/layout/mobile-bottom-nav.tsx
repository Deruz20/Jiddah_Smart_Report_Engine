...
import { useIsMobile } from "../figma-ui/ui/use-mobile";
...
const navItems = [
  ...
  { icon: ClipboardEdit, label: "Marks", id: "marks", href: "/admin/marks" },
  { icon: Printer, label: "Reports", id: "reports", badge: 3, href: "/admin/reports" },
