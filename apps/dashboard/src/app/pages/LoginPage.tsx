...
export default function LoginPage() {
  ...
  const { login, signUp, error: authError, isAuthenticated, loading: authLoading } = useAuthContext();
  ...
  const handleLogin = async (values: LoginForm) => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : authError ?? "Unable to sign in";
      toast.error(message);
    } finally {
      setLoading(false);
    }
  ...
  const handleSignUp = async (values: SignUpForm) => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : authError ?? "Unable to create account";
      toast.error(message);
    } finally {
      setLoading(false);
    }
