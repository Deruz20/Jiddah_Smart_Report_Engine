...
export default function PrimaryEOTReport({ reportData }: any) {
  const className = reportData?.class_name || reportData?.class || reportData?.student?.class_name || '';
      ...
      <div className="primary-eot-report">
        ...
        <header className="header">
          ...
          <div className="header-center">
            ...
            <div className="report-badge">{isLower ? 'LOWER' : 'UPPER'} REPORT FORM - END OF TERM</div>
          </div>
