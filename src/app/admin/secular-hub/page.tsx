...
import SecularHubClient from '@/components/secular-hub/SecularHubClient'
...
export default async function SecularHubPage() {
  let terms: TermData[] = []
  let circularClasses: CircularClassData[] = []
  ...
  try {
    ...
    terms = termsRes.data || []
    circularClasses = classesRes.data || []
  } catch (err) {
