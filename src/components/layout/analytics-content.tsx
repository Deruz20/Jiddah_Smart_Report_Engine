...
// Using standard alert for now instead of sonner toast to avoid missing deps
    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="rounded-2xl p-6" style={{ background: "white", border: "1px solid rgba(0,0,0,0.07)", boxShadow: "0 1px 8px rgba(0,0,0,0.04)" }}>
          ...
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={data.termPerformance} barSize={28} barGap={4}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="rounded-2xl p-6" style={{ background: "white", border: "1px solid rgba(0,0,0,0.07)", boxShadow: "0 1px 8px rgba(0,0,0,0.04)" }}>
          ...
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={data.subjectPerformance} layout="vertical" barSize={10}>
      ...
      <div className="rounded-2xl overflow-hidden mb-8" style={{ background: "white", border: "1px solid rgba(0,0,0,0.07)", boxShadow: "0 1px 8px rgba(0,0,0,0.04)" }}>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[700px]">
            ...
            <tbody>
              {data.classPerformance.map((cls, i) => (
                <tr key={cls.class} style={{ borderBottom: i < data.classPerformance.length - 1 ? "1px solid rgba(0,0,0,0.04)" : "none" }}
                  ...
                  <td className="px-5 py-3.5 whitespace-nowrap" style={{ fontSize: "15px", fontWeight: 700, color: cls.avg >= 85 ? "#10B981" : cls.avg >= 75 ? "#F59E0B" : "#EF4444" }}>
                    {cls.avg}%
                  </td>
                  <td className="px-5 py-3.5 whitespace-nowrap" style={{ fontSize: "13px", color: "#374151" }}>
                    {cls.avg >= 80 ? "98%" : cls.avg >= 75 ? "94%" : "87%"}
                  </td>
                  <td className="px-5 py-3.5 whitespace-nowrap" style={{ fontSize: "13px", color: "#6B7280" }}>—</td>
                  <td className="px-5 py-3.5 whitespace-nowrap" style={{ fontSize: "13px", color: "#6B7280" }}>7 subjects</td>
