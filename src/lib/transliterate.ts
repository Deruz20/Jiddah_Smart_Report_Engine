...
const ISLAMIC_NAMES_DICT: Record<string, string> = {
  ...
  'musa': 'موسى', 'mousa': 'موسى', 'mussa': 'موسى', 'muusa': 'موسى',
  ...
  'sumayya': 'سمية', 'sumaiyah': 'سمية', 'sumayyah': 'سمية',
  ...
  'nuru': 'نور', 'noor': 'نور',
  'salma': 'سلمى',
  'asmak': 'أسماء', 'asma': 'أسماء', 'asmah': 'أسماء',
  'jamila': 'جميلة', 'jamilah': 'جميلة',
  'shadia': 'شادية',
  'amiirah': 'أميرة', 'amira': 'أميرة', 'ameerah': 'أميرة', 'amiirat': 'أميرة',
  'hakiimah': 'حكيمة', 'hakima': 'حكيمة',
  'sameeha': 'سميحة', 'samiha': 'سميحة',
  'rahmah': 'رحمة', 'rahma': 'رحمة',
  'maysarat': 'ميسرة', 'maysara': 'ميسرة',
  'shukran': 'شكران',
  'nasheem': 'نسيم', 'nashim': 'نسيم',
  'leilah': 'ليلى', 'laila': 'ليلى', 'layla': 'ليلى',
  'kabiirah': 'كبيرة', 'kabira': 'كبيرة',
  'swalha': 'صالحة', 'swaliha': 'صالحة', 'saliha': 'صالحة',
  'taubah': 'توبة',
  'daliirah': 'دليرة', 'daliira': 'دليرة', 'dalira': 'دليرة'
};
